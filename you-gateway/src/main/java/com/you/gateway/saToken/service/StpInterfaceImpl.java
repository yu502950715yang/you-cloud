package com.you.gateway.saToken.service;
...
import com.you.gateway.service.UserService;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public StpInterfaceImpl(RedisService redisService, UserService userService) {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (redisService.hasKey(redisKey)) {
            ...
            // 如果不存在，则先查询再存入缓存中
            permissionList = userService.getPermissions(userId);
            // 存入redis
