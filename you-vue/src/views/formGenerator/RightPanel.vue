    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.treeData!==undefined" label="展示数据">
            <el-input v-model="activeData.treeData" placeholder="请输入展示数据" />
          </el-form-item>
          <el-form-item v-if="activeData.nodeKey!==undefined" label="节点标识">
            <el-input v-model="activeData.nodeKey" placeholder="请输入节点标识" />
          </el-form-item>
          <el-form-item v-if="activeData.defaultCheckedKeys!==undefined" label="默认展开">
            <el-input v-model="activeData.defaultCheckedKeys" placeholder="请输入默认展开的节点的 key 的数组" />
          </el-form-item>
          ...
          <template v-if="activeData.dataType === 'tree'">
            <el-form-item label="标签键名">
              <el-input v-model="activeData.treeProps.props.label" placeholder="请输入标签键名" />
            </el-form-item>
            <el-form-item label="子级键名">
              <el-input v-model="activeData.treeProps.props.children" placeholder="请输入子级键名" />
            </el-form-item>
            <el-form-item label="禁用键名">
              <el-input v-model="activeData.treeProps.props.disabled" placeholder="请输入禁用键名" />
            </el-form-item>
          </template>
          <el-form-item v-if="activeData.showCheckbox !== undefined" label="可被选择">
            <el-switch v-model="activeData.showCheckbox" />
          </el-form-item>
          <el-form-item v-if="activeData.defaultExpandAll !== undefined" label="默认展开所有">
            <el-switch v-model="activeData.defaultExpandAll" />
          </el-form-item>
          <el-form-item v-if="activeData.checkStrictly !== undefined && activeData.showCheckbox === true" label="父子不关联">
