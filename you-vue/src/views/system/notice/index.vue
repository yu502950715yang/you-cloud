<template>
   <div class="app-container">
      ...
      <pagination v-show="total > 0" :total="total" v-model:page="queryParams.page.current"
         v-model:limit="queryParams.page.size" @pagination="getList" />
...
function getList() {
   loading.value = true;
   listNotice(proxy.addDateRange(queryParams.value)).then(res => {
